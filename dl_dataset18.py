...
from sklearn.metrics import accuracy_score, f1_score, roc_auc_score, matthews_corrcoef, classification_report,precision_score, recall_score
import pandas as pd
import numpy as np
...
prot_columns = [col for col in feature_data.columns if col.startswith("prot")]

train_data = feature_data[feature_data["is_Train"] == 1][prot_columns + ["label"]]
test_data = feature_data[feature_data["is_Train"] == 0][prot_columns + ["label"]]
