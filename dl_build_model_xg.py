...
def train_model(X_train, y_train):
    ...
    grid_search = GridSearchCV(estimator=xgb, param_grid=param_grid, cv=10, scoring='f1')
...
pd.DataFrame(results, columns=columns).to_csv("all_features_models_xgb.csv", index=False)
print("Results saved")
