...
def train_model(X_train, y_train):
    ...
    grid_search = GridSearchCV(estimator=svm, param_grid=param_grid, cv=10, scoring='f1')
...
pd.DataFrame(results, columns=columns).to_csv("all_features_models_svm.csv", index=False)
print("Results saved")
